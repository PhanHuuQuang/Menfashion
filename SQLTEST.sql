USE master
GO
IF EXISTS(SELECT NAME FROM sysdatabases WHERE NAME = 'menfashion1')
BEGIN
	DROP DATABASE [menfashion1]
END
GO
	CREATE DATABASE [menfashion1] 
GO
-- Tạo bảng
...
CREATE TABLE [dbo].[Color](
	[colorId] INT IDENTITY PRIMARY KEY([colorId]),
	[nameColor] varchar(50) NOT NULL
)
GO
CREATE TABLE [dbo].[Size](
	[sizeId] INT IDENTITY PRIMARY KEY([sizeId]),
...
ALTER TABLE [dbo].[Amount] ADD quantityId INT IDENTITY PRIMARY KEY([quantityId]) 
-- Tạo khóa ngoại
ALTER TABLE  [dbo].[Product] ADD CONSTRAINT FK_PRODUCT_MEMBER2 FOREIGN KEY([userName]) REFERENCES dbo.[Member]([userName])
ALTER TABLE  [dbo].[Product] ADD CONSTRAINT FK_PRODUCT_CATEGORY2 FOREIGN KEY(categoryId) REFERENCES dbo.[productCategory]([categoryId])
ALTER TABLE  [dbo].[Member]  ADD CONSTRAINT FK_MEMBER_ROLE2 FOREIGN KEY([roleId]) REFERENCES dbo.[Role]([roleId])
ALTER TABLE  [dbo].[Articles] ADD CONSTRAINT FK_POST_MEMBER3 FOREIGN KEY([userName]) REFERENCES dbo.[Member] ([userName])
ALTER TABLE  [dbo].[Articles] ADD CONSTRAINT FK_POST_CATEGORY3 FOREIGN KEY([categoryId]) REFERENCES dbo.[productCategory]([categoryId])
ALTER TABLE  [dbo].[Invoince] ADD CONSTRAINT FK_INVOINCE_MEMBER3 FOREIGN KEY([userName]) REFERENCES dbo.[Member] ([userName])
ALTER TABLE  [dbo].[Invoince] ADD CONSTRAINT FK_INVOINCE_CUSTOMER3 FOREIGN KEY([customerId]) REFERENCES dbo.[Customer]([customerId])
ALTER TABLE  [dbo].[InvoinceDetail] ADD CONSTRAINT FK_INVOINCEDETAIL_INVOINCE3 FOREIGN KEY([invoinceNo]) REFERENCES [dbo].[Invoince]([invoinceNo])
ALTER TABLE  [dbo].[InvoinceDetail] ADD CONSTRAINT FK_INVOINCEDETAIL_PRODUCT2 FOREIGN KEY([productId]) REFERENCES [dbo].[Product]([productId])
ALTER TABLE [dbo].[Amount] ADD CONSTRAINT FK_Amount1_PRODUCT1 FOREIGN KEY([productId]) REFERENCES [dbo].[Product]([productId])
ALTER TABLE [dbo].[Amount] ADD CONSTRAINT FK_Amount1_Color1 FOREIGN KEY([colorId]) REFERENCES [dbo].[Color]([colorId])
ALTER TABLE [dbo].[Amount] ADD CONSTRAINT FK_Amount1_Size1 FOREIGN KEY([sizeId]) REFERENCES [dbo].[Size]([sizeId]) 
-- [category]
...
--[Color]
INSERT INTO [dbo].[Color]([nameColor]) VALUES (N'Black')
INSERT INTO [dbo].[Color]([nameColor]) VALUES (N'White')

--[Size]
INSERT INTO [dbo].[Size]([nameSize]) VALUES (N'S')
INSERT INTO [dbo].[Size]([nameSize]) VALUES (N'M')
INSERT INTO [dbo].[Size]([nameSize]) VALUES (N'L')
INSERT INTO [dbo].[Size]([nameSize]) VALUES (N'XL')
INSERT INTO [dbo].[Size]([nameSize]) VALUES (N'XXL')
--[Amount]
INSERT INTO [dbo].[Amount] ([productId], [colorId], [sizeId], [quality]) VALUES (1,1,1,15)
INSERT INTO [dbo].[Amount] ([productId], [colorId], [sizeId], [quality]) VALUES (1,1,2,16)
INSERT INTO [dbo].[Amount] ([productId], [colorId], [sizeId], [quality]) VALUES (1,1,3,17)
INSERT INTO [dbo].[Amount] ([productId], [colorId], [sizeId], [quality]) VALUES (1,2,1,18)
INSERT INTO [dbo].[Amount] ([productId], [colorId], [sizeId], [quality]) VALUES (1,2,2,19)
INSERT INTO [dbo].[Amount] ([productId], [colorId], [sizeId], [quality]) VALUES (1,2,3,1)
